...
void main(){
    ...
    color2  = mix (color,vec3(0.4784, 0.502, 0.1373),pct * u_mouse.x);

    // Now we have 9 spaces that go from 0-1

    //color = vec3(Cardinal_Partician,0.0);
    color = smoothstep(vec3(circle(Cardinal_Partician ,0.9994)),vec3((Cardinal_Partician.x *sin(sqrt(abs(u_time))),0.3),Cardinal_Partician.y,0.98), color2);
